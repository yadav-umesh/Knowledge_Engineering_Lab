...
public class Decision{
	...
	//find Information gain of the dataset (or table)
	...
	// calculating Information gain of each attributes
	...
	int findAttrIndex(List<List<String>> data) {
		...
		float max=-1;
		int index=-1;
	// we need to find information gain of all attributes except first and last
...
//			after deciding the highest gain that column need to be remove
...
//			System.out.println("class:"+n.name+"  incoming edge:("+n.incoming_edge+")");
		...
		//label  the node n  with split criterion
